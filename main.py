...
from prad.modules.model import CoreModel
from prad.modules.utils import device, mse2psnr, \
    grad_loss, safe_path, set_seed
from prad.modules.config import config_parser
from prad.dataloader.dataset import Data_m
...
class Trainder(object):
    def __init__(self, args):
        ...
        self.imgout_path = safe_path(os.path.join(self.imgpath, 'test_chair'))
    ...
    def train(self,epoch_n=30):
        ...
        for epoch in range(epoch_n):
            ...
            for id in tqdm(ids):
                ...
                # img = self.imagesgt_train[id].detach().permute(2, 0, 1)
